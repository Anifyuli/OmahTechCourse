...
<body class="bg-success">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="#card">Pinjaman Terbanyak</a>
            </li>
            <a class="nav-link active text-right btn btn-danger" href="../logout.php"><span class="fas fa-sign-out-alt"></span> Keluar</a>
            </ul>
        </div>
        </nav>
    ...
    <section id="card" class="container-fluid">
        <h4 class="text-white">Buku dengan Peminjaman Terbanyak</h4>
        <?php
        include ("../connect.php");
    ...
    <section class="container-fluid mb-5">
        <h3 class="text-white">Berita di Perpus Daring</h3>
        <div class="card-deck my-3 text-dark">
                <div class="card bg-light">
                    <div class="card-body">
                        <h5 class="card-title">Pembaruan Fitur</h5>
                        <p class="card-text">Pembaruan akan digulir setiap 10 hari, maka dari itu tetaplah mengikuti beritanya di media sosial kami ya! Stay tune!</p>
                    </div>
                </div>
        </div>
    </section>
