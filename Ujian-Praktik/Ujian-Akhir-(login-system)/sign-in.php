...
<body>
        ...
        <div class="card">
            ...
            <form action="" method="post" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <input type="" name="password" class="form-control" value="<?= $row['password']; ?>">
                    </div>
                    <div class="form-group">
                        <label>Pengguna </label>
                        <input type="text" name="level" class="form-control" value="<?= $row['level']; ?>">
                    </div>
                    <button type="submit" class="btn btn-primary" name="submit" value="simpan">Masuk</button>
                </form>
    ...
    <div class="container">
        <div class="card">
            ...
            <div class="card-body">
                <p>Silahkan isi kolom pengguna dengan user untuk mendapat layanan sebagai pengguna Perpus Daring Al-Hikmah</p>
            </div>
        </div>
    </div>
