    ...
    <div class="container my-3 mx-auto">
        ...
        <div class="card">
            <div class="card-header bg-success text-white ">
                Data Buku <a href="./tambah-buku.php" class="btn btn-sm btn-primary float-right"><span class="fas fa-plus"></span> Tambah</a>
            </div>
            <div class="card-body">
                <form action="" method="post" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" name="deskripsi" class="form-control" value="<?= $row['deskripsi']; ?>"></textarea>
                    </div>                    
                    <div class="form-group">
                        <label>Jenis</label>
				...
				if (isset($_POST['submit'])) {
					...
					$datas = mysqli_query($conn, "INSERT into buku (idbuku,judul,pengarang,penerbit,deskripsi,jenis,terpinjam,jumlah)values('$idbuku','$judul','$pengarang','$penerbit','$deskripsi','$jenis','$terpinjam','$jumlah')") or die(mysqli_error($conn));
				
					echo "<script>alert('Buku berhasil disimpan!');window.location='index.php';</script>";
				}
				?>
            </div>
        </div>
