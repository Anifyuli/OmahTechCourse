    ...
    <div class="container my-3 mx-auto">
        ...
        <div class="card">
            <div class="card-header bg-success text-white ">
                Data Pengguna <a href="./tambah-pengguna.php" class="btn btn-sm btn-primary float-right"><span class="fas fa-plus"></span> Tambah</a>
            </div>
            <div class="card-body">
            <form action="" method="post" role="form">
                    ...
                    <div class="form-group">
                        <label>Pengguna (admin/user) </label>
				...
				if (isset($_POST['submit'])) {
					...
					echo "<script>alert('Kontak berhasil disimpan!');window.location='index.php';</script>";
				}
				?>
            </div>
        </div>
